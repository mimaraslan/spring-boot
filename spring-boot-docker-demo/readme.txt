...
## TERMINAL 2
cd /Users/mimaraslan/Documents/workspace/spring-boot/spring-boot-docker-demo/
docker build -t spring-boot-docker-demo .

docker run -p 8089:8089 -t --name spring-boot-docker-demo --link mysql-standalone:mysql spring-boot-docker-demo